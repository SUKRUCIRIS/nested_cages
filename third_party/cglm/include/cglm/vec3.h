 ...
 */
CGLM_INLINE
void glm_vec3_adds(vec3 v, float s, vec3 dest)
{
	dest[0] = v[0] + s;
	dest[1] = v[1] + s;
	dest[2] = v[2] + s;
 ...
 */
CGLM_INLINE
void glm_vec3_subsub(vec3 a, vec3 b, vec3 dest)
{
	dest[0] -= a[0] - b[0];
	dest[1] -= a[1] - b[1];
	dest[2] -= a[2] - b[2];
 ...
 */
CGLM_INLINE
void glm_vec3_addsub(vec3 a, vec3 b, vec3 dest)
{
	dest[0] -= a[0] + b[0];
	dest[1] -= a[1] + b[1];
	dest[2] -= a[2] + b[2];
 ...
 */
CGLM_INLINE
void glm_vec3_mulsub(vec3 a, vec3 b, vec3 dest)
{
	dest[0] -= a[0] * b[0];
	dest[1] -= a[1] * b[1];
	dest[2] -= a[2] * b[2];
 ...
 */
CGLM_INLINE
void glm_vec3_maxsub(vec3 a, vec3 b, vec3 dest)
{
	dest[0] -= glm_max(a[0], b[0]);
	dest[1] -= glm_max(a[1], b[1]);
	dest[2] -= glm_max(a[2], b[2]);
 ...
 */
CGLM_INLINE
void glm_vec3_minsub(vec3 a, vec3 b, vec3 dest)
{
	dest[0] -= glm_min(a[0], b[0]);
	dest[1] -= glm_min(a[1], b[1]);
	dest[2] -= glm_min(a[2], b[2]);
 ...
 */
CGLM_INLINE
float glm_vec3_distance2(const vec3 a, const vec3 b)
{
 ...
 */
CGLM_INLINE
float glm_vec3_distance(const vec3 a, const vec3 b)
{
 ...
 */
CGLM_INLINE
void glm_vec3_lerpc(vec3 from, vec3 to, float t, vec3 dest)
{
 ...
 */
CGLM_INLINE
void glm_vec3_mix(vec3 from, vec3 to, float t, vec3 dest)
{
 ...
 */
CGLM_INLINE
void glm_vec3_mixc(vec3 from, vec3 to, float t, vec3 dest)
{
 ...
 */
CGLM_INLINE
void glm_vec3_smoothinterp(vec3 from, vec3 to, float t, vec3 dest)
{
	vec3 s, v;
 ...
 */
CGLM_INLINE
void glm_vec3_smoothinterpc(vec3 from, vec3 to, float t, vec3 dest)
{
 ...
 */
CGLM_INLINE
void glm_vec3_make(const float *__restrict src, vec3 dest)
{
	dest[0] = src[0];
	dest[1] = src[1];
	dest[2] = src[2];
 ...
 */
CGLM_INLINE
void glm_vec3_faceforward(vec3 n, vec3 v, vec3 nref, vec3 dest)
{
 ...
 */
CGLM_INLINE
bool glm_vec3_refract(vec3 v, vec3 n, float eta, vec3 dest)
{
	float ndi, eni, k;
